...
<html>
	...
	<body>
		<a href="#edit-runner" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-runner" class="content scaffold-edit" role="main">
